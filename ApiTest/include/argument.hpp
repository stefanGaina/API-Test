#ifndef APITEST_ARGUMENT_HPP_
#define APITEST_ARGUMENT_HPP_
...
private:
	[[nodiscard]] std::int64_t getSignedInteger(std::int64_t minimum, std::int64_t maximum) const noexcept(false);

	[[nodiscard]] std::uint64_t getUnsignedInteger(std::uint64_t maximum) const noexcept(false);
	 ...
	 *************************************************************************************************/
	void throwIfTrailingCharacters(std::size_t position) const noexcept(false);
};
...
/** ***************************************************************************************************
 * @brief This class allows apitest::argument to be formatted so it can be a parameter to
 * std::print and similar functions.
 *****************************************************************************************************/
template<>
class formatter<apitest::argument> : public formatter<string>
{
public:
	/** ***********************************************************************************************
	 ...
	 *************************************************************************************************/
	auto format(apitest::argument argument, format_context& context) const noexcept(false)
	{
